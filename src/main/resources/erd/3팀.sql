...
(
	...
	TA_BOUNDARY varchar(30) NOT NULL,
	TA_DESC varchar(50),
	TA_MANNER_POINT varchar(30) NOT NULL,
	TA_STATUS char DEFAULT '1' NOT NULL,
	TA_TYPE varchar(100) NOT NULL,
	TA_MATCH_COUNT int(1000) DEFAULT 0 NOT NULL,
	TA_FILE_PATH varchar(300),
	TA_FILE_NAME varchar(300),
	TA_POINT int(1000) NOT NULL,
	PRIMARY KEY (TA_NUM),
	UNIQUE (TA_NAME)
);
