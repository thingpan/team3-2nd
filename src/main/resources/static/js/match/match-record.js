async function getTeamInfo() {
	...
	//매치 작성 목록이 5개 이상이면 더보기 뜨기
	if (pageInfos.size < 5) {
		document.querySelector('#moreListBtn').style.display = 'none';
	}
	...
	//팀원 목록이 5개 이상이면 더보기 뜨기
	if (membersInfo.size < 5) {
		document.querySelector('#moreMemberBtn').style.display = 'none';
	}
